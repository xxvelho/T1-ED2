...
public class MergeSort {
    ...
    private static void mergeMainInsertion(Estrutura<?, ?>[] vetor, Estrutura<?, ?>[] temp, int esq, int dir) {
        int meio;
        if(esq < dir) {
            ...
            } else { 						// Se o subconjunto tiver 15 elementos ou menos, o insertion sort � utilizado
    ...
    private static void mergeMain(Estrutura<?, ?>[] vetor, Estrutura<?, ?>[] temp, int esq, int dir) {
        int meio;
